...
1. Descarga el paquete [bayesian-compose-skill.zip](https://github.com/novanoticia/bayesian-compose-plugin/releases/latest/download/bayesian-compose-skill.zip).
